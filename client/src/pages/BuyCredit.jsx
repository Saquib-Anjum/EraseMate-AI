    ...
    <div className="min-h[80vh] text-center pt-14 mb-10">
      ...
      <div className="flex flex-wrap justify-center gap-6 text-left">
        {plans.map((item, idx) => (
          <div
            key={idx}
            className="bg-white drop-shadow-sm border-white border rounded-xl py-12 px-8 textgray-700 hover:scale-105 transition-all duration-500"
          >
            <img width={40} src={assets.favicon1} alt="" />
