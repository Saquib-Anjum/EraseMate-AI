  ...
  return (
    <div className="mx-4 my-3 lg:mx-44 min-h-[75vh]">
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        <div className=" flex flex-col sm:grid grid-cols-2 gap-8 ">
          ...
          <div className="flex flex-col">
            ...
            <div className="rounded-md border border-gray-300 h-full relative bg-layers overflow-hidden ">
              <img src={resultImage?resultImage:""} alt="" className=" rounded-md border" />
              {
        ...
        {/* buttons */}
      {
        resultImage &&  <div className="flex justify-center sm:justify-end item-center flex-wrap gap-4 mt-6">
        ...
        <a className="px-8 py-2.5 text-white text-sm bg-gradient-to-r from-violet-600 to-fuchsia-500  rounded-full hover:scale-105 transition-all duration-400" href={resultImage} download>Download image</a>
      </div>
      }
