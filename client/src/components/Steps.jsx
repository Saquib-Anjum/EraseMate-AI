  ...
  return (
    <div className='mx-4 lg:mx-44 py-20 xl:py-40'>
      ...
      <div className="flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center">
            <div className="flex items-start gap-4 bg-white shadow-[0px_7px_29px_0px_rgba(100,100,111,0.2)] p-7 pb-10 rounded hover:scale-105 transition-all duration-500"> 
